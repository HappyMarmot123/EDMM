...
Audius와 Deezer에서 제공하는 공개 API를 기반으로 개발하였습니다.   
...
### 백엔드 & 데이터
- Music API: Audius, Deezer, lyrics.ovh
- Local Data: Dexie IndexedDB
- Media: remote artwork via next/image

### 상태관리 / 테스팅
- Client State: Zustand 5.0
- Server State: TanStack Query 5.101 (React Query)
- Framework: Jest
...
### 3. 데이터 레이어
서버 API 어댑터는 Audius/Deezer/lyrics.ovh를 표준 Track 모델로 변환합니다.
즐겨찾기, 최근 재생, 재생목록, 트랙 캐시는 Dexie IndexedDB에 저장합니다.
